...
registerCronJob(
  "30 21 * * *",
  "Discord 每日提醒",
  "系統提醒：現在是每日經文時間，請你「參考你上一個給我的經文」，從「下一個章節」中任選一節，附上簡短分享和禱告詞，讓大家可以藉此思想。舉例：前一天是馬太福音1:2，今天就應該是馬太福音第2章中由你任選一節，後天是馬太福音第3章。假如查詢不到前一天的經文，就從出埃及記第29章開始。",
  process.env.DISCORD_CHANNEL_ID,
  { platform: "discord" } // 告訴 callGPT 這次要發到 Discord
);
